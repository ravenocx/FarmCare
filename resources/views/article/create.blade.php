...
<body class="font-poppins">
    ...
    <div class="flex" style="margin-top: 12vh;">
        ...
        <div class="w-10/12 h-auto p-12 flex flex-col gap-y-4 ml-64">
            <a href="{{ route('article.index') }}" class="flex gap-x-2 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#8D7B68" class="w-6 h-6">
            ...
            <form action="{{ route('article.store') }}" enctype="multipart/form-data" method="post" class="px-8 mt-4 flex flex-col gap-y-4">
                @csrf
                ...
                <div class="border border-[#F1DEC9] rounded-lg px-10 py-5">
                    <div>
                        ...
                        <input type="text" name="title" placeholder="Title Article..." required class="w-full text-black border border-[#F1DEC9] p-4 rounded-lg mt-3">
                    </div>
                    <div class="mt-4">
                        <label for="category" class="text-xl text-[#888888] font-medium">Category</label>
                        <select name="category" id="category" class="w-full text-black border border-[#F1DEC9] p-4 rounded-lg mt-3" required>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="message" rows="4" name="content" class="block w-full text-black border-[#F1DEC9] p-4 mt-3 rounded-lg border" placeholder="Content here..." required></textarea>
                    </div>
                </div>
                <div class="my-2">
                ...
                <div class="w-full p-6 border border-[#F1DEC9] grid grid-cols-4 gap-x-4">
                    <div class="relative profile-pic-div w-fit">
                        ...
                        <label class="hidden w-48 h-48 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer transition-all" for="file" id="uploadBtn" style="background-color: rgba(217,217,217,0.8)">
                            <div class="absolute w-10/12 flex flex-col items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    ...
    <div id="alert-2" class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 fixed bottom-5 right-5 z-20" role="alert">
