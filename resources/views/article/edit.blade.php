    ...
    <div class="flex" style="margin-top: 12vh;">
        ...
        <div class="w-10/12 h-auto p-12 flex flex-col gap-y-4 ml-64">
            ...
            <form action="{{ route('article.update', $article->id) }}" enctype="multipart/form-data" method="post"
                ...
                @csrf
                @method('patch')
                <h1 class="text-3xl font-medium">Add New Article</h1>
                ...
                <div class="border border-[#F1DEC9] rounded-lg px-10 py-5">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category" id="category"
                            ...
                            <option value="Enteritis Hemogarik" {{ $article->category == "Enteritis Hemogarik" ? 'selected' : '' }}>Enteritis Hemogarik</option>
                ...
                <div class="w-full p-6 border border-[#F1DEC9] grid grid-cols-4 gap-x-4">
                    <div class="relative profile-pic-div w-fit">
                        <img class="w-48 h-48" src="{{ asset('storage/articlePhoto/'. $article->photo1) }}" id="photo" alt="Photo of Profile">
                    ...
                    <div class="relative profile-pic-div-2 w-fit">
                        <img class="w-48 h-48" src="{{ asset('storage/articlePhoto/'. $article->photo2) }}" id="photo-2" alt="Photo of Profile">
                    ...
                    <div class="relative profile-pic-div-3 w-fit">
                        <img class="w-48 h-48" src="{{ asset('storage/articlePhoto/'. $article->photo3) }}" id="photo-3" alt="Photo of Profile">
                    ...
                    <div class="relative profile-pic-div-4 w-fit">
                        <img class="w-48 h-48" src="{{ asset('storage/articlePhoto/'. $article->photo4) }}" id="photo-4" alt="Photo of Profile">
