    ...
    <div class="flex" style="margin-top: 12vh;">
        ...
        <div class="w-10/12 h-auto p-12 flex flex-col gap-y-4 ml-64">
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <div
                    class="max-w-sm bg-[#8D7B68] border border-gray-200 rounded-lg shadow p-3 flex flex-col justify-between">
                    <div class="bg-center bg-cover bg-no-repeat rounded-lg"
                        style="background-image: url('{{ asset('storage/articlePhoto/'. $article->photo1) }}')">
                    ...
                    <div class="flex items-center gap-x-5">
                        <a href="{{ route('article.edit', $article->id) }}"
                            class="w-1/2 py-2 bg-yellow-500 text-white text-center text-sm font-medium rounded-lg">Edit</a>
